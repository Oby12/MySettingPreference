...
class MyPreferenceFragment : PreferenceFragmentCompat(),
    ...
    //deklarasi varibale yang akan kita gunakan
    ...
    //init() digunakan untuk memanggil komponen seperti EditTextPreference dan CheckBoxPreference
    ...
    //Perintah setSummary berguna untuk mengubah value dari EditTextPreference menjadi nilai
    //yang baru sesuai dengan data yang tersimpan.
    ...
    //Kode ini digunakan untuk me-register ketika aplikasi dibuka dan me-unregister ketika aplikasi ditutup.
    ...
    //Kode di atas digunakan untuk mengecek apakah terjadi perubahan pada data yang tersimpan. Jika terdapat value yang berubah
    //maka akan memanggil listener onSharedPreferenceChanged
